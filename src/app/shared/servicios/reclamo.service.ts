...
export class ReclamoService {
  ...
  getReclamoById(idReclamo: string): Observable<SolicitudGetModel> {
    return this.http.get<SolicitudGetModel>(`${environment.baseUrl}/solicitud/reclamo/${idReclamo}`, this.httpOptions)
  }
}
